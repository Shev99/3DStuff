...
def add_box( points, x, y, z, w, h, d ):#w:width h:height d:depth 
...
def add_sphere( points, cx, cy, cz, r, step ):
    sph = generate_sphere(points, cx, cy, cz, r, step)
    for i in sph:
